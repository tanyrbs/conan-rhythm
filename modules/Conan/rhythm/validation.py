...
from .stages import resolve_runtime_dual_mode_teacher_enable
from .supervision import RHYTHM_CACHE_VERSION
...
def validate_stage_contract(
    ...
    *,
    ...
    export_debug_sidecars = bool(hparams.get("rhythm_export_debug_sidecars", False))
    ...
    contract = expected_cache_contract(hparams)
