...
def build_streaming_rhythm_module_from_hparams(hparams) -> StreamingRhythmModule:
    ...
    return StreamingRhythmModule(
        ...
        pause_breath_features_enable=bool(hparams.get('rhythm_pause_breath_features_enable', False)),
        pause_breath_reset_threshold=float(hparams.get('rhythm_pause_breath_reset_threshold', 0.55)),
        role_memory_conditioning_scale=float(hparams.get('rhythm_role_memory_conditioning_scale', 0.30)),
        local_role_query_scale=float(hparams.get('rhythm_local_role_query_scale', 0.45)),
        role_global_prior_scale=float(hparams.get('rhythm_role_global_prior_scale', 0.20)),
        role_memory_temperature=float(hparams.get('rhythm_role_memory_temperature', 0.75)),
        min_speech_frames=float(hparams.get('rhythm_projector_min_speech_frames', 1.0)),
